...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_1_label_1, "Plastic ! ");
	lv_label_set_long_mode(ui->screen_1_label_1, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_1_label_1, 172, 217);
	lv_obj_set_size(ui->screen_1_label_1, 147, 32);
	...
	lv_obj_set_style_text_font(ui->screen_1_label_1, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_imgbtn_set_src(ui->screen_1_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_plastic_alpha_75x169, NULL);
	lv_imgbtn_set_src(ui->screen_1_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_plastic_alpha_75x169, NULL);
	lv_imgbtn_set_src(ui->screen_1_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_plastic_alpha_75x169, NULL);
	lv_imgbtn_set_src(ui->screen_1_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_plastic_alpha_75x169, NULL);
	...
	lv_obj_set_pos(ui->screen_1_imgbtn_1, 203, 30);
	lv_obj_set_size(ui->screen_1_imgbtn_1, 75, 169);
